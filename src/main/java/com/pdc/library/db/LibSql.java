...
public class LibSql {
    ...
    public static final String SELECT_USER_BOOKS_BY_USER_ID =
            "SELECT " + USER_BOOK_TABLE_NAME + ".*, " + BOOK_TABLE_NAME + ".BookName, " + BOOK_TABLE_NAME + ".BookAuthor, " + USER_TABLE_NAME + ".UserName " +
                    ...
                    "WHERE " + USER_BOOK_TABLE_NAME + ".UserID = ?";

    public static final String SELECT_USER_BOOK_BY_BOOK_ID =
            "SELECT " + USER_BOOK_TABLE_NAME + ".*, " +
                    BOOK_TABLE_NAME + ".BookName, " +
                    BOOK_TABLE_NAME + ".BookAuthor, " +
                    USER_TABLE_NAME + ".UserName " +
                    "FROM " + USER_BOOK_TABLE_NAME +
                    " JOIN " + BOOK_TABLE_NAME +
                    " ON " + USER_BOOK_TABLE_NAME + ".BookID = " + BOOK_TABLE_NAME + ".BookID " +
                    " JOIN " + USER_TABLE_NAME +
                    " ON " + USER_BOOK_TABLE_NAME + ".UserID = " + USER_TABLE_NAME + ".UserID " +
                    "WHERE " + USER_BOOK_TABLE_NAME + ".BookID = ?";
